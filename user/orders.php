...
<div class="container-fluid">
    ...
    while ($row_category = $result_categories->fetch_assoc()) {
        ...
        while ($row_menu = $result_menu->fetch_assoc()) {
            ...
            // Tambahkan kondisi untuk menonaktifkan tombol Buy jika stok 0
            if ($row_menu["stok"] == 0) {
                echo '<button class="btn btn-mainColor text-white col-12" disabled>Out of Stock</button>';
            } else {
                echo '<button type="submit" class="btn btn-mainColor col-12">Buy</button>';
            }
