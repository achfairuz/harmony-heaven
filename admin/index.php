...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap  shadow d-flex align-item-center px-2">
        <h1 class="navbar-brand fw-bold" style="color: #ff6851; background-color: transparent;"><span class="fw-light">Hello,</span>
            <?php
            session_start();
            include "koneksi.php";
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky ">
                    <ul class="nav flex-column mt-3">
                        <li class="nav-item">
                            <a class="nav-link  <?php if ($page == 'dashboard' || $page == '') echo 'active'; ?> " aria-current="page" href="?page=dashboard">
                                <span data-feather="home"></span>
                                Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($page == 'order') echo 'active'; ?>" href="?page=order">
                                <span data-feather="file"></span>
                                Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($page == 'product') echo 'active'; ?>" href="?page=product">
                                <span data-feather="shopping-cart"></span>
                                Products
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($page == 'customers') echo 'active'; ?>" href="?page=customers">
                                <span data-feather="users"></span>
                                Customers
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($page == 'meja') echo 'active'; ?>" href="?page=meja">
